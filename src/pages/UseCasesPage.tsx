...
const USE_CASES: UseCase[] = [
  {
    ...
    pain: 'Teasers arrive faster than they can be screened. Memo quality varies by analyst. Gaps in customer concentration, ARR definition and AI defensibility often surface only after diligence spend has begun.',
  ...
  },
  {
    ...
    pain: 'Buyer diligence questions tend to cover ARR quality, customer concentration, AI defensibility and EBITDA adjustments. Preparing clear answers from client materials is time-intensive and inconsistent.',
  ...
  },
  {
    ...
    pain: 'Operating partners are expected to assess AI risk for every portfolio addition. There is no standard framework for judging whether AI can replicate the product or expand or compress the business.',
