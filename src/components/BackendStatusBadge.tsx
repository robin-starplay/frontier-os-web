...
export function BackendStatusBadge({
  ...
  const cfg: Record<Status, { label: string; dot: string; text: string }> = {
    ...
    connected:    { label: 'Backend connected',        dot: 'bg-[var(--semantic-verified-text)]', text: 'text-[var(--semantic-verified-text)]' },
    unavailable:  { label: 'Backend unavailable',      dot: 'bg-[var(--semantic-claim-text)]', text: 'text-[var(--semantic-claim-text)]' },
