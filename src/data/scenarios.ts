...
export const DEMO_SCENARIOS: DemoScenario[] = [
  {
    ...
    jurisdiction: 'UK',
    mode: 'URL-only',
    buyer_thesis: 'PE platform add-on: recurring revenue, EBITDA quality and ARR confirmation',
    ...
    diligence_questions: [
      ...
      'Provide customer concentration for the top 5 and top 10 customers by revenue.',
  ...
  },
  {
    ...
    jurisdiction: 'US',
    mode: 'URL-only',
    buyer_thesis: 'Cross-border acquisition screen: public target with SEC filings available',
  ...
  },
  {
    ...
    jurisdiction: 'DE',
    mode: 'URL-only',
    buyer_thesis: 'DACH vertical SaaS roll-up: niche product with limited public evidence',
    ...
    diligence_questions: [
      ...
      'Provide customer concentration for the top 5 customers by revenue.',
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    mode: 'Document-assisted',
    buyer_thesis: 'Sell-side Q&A preparation: identify buyer questions before process launch',
