...
const privateEquity: BuyerPageData = {
  ...
  howHelps: [
    ...
    'AI disruption screen covering replica risk, moat evidence and inference economics.',
  ...
  lockedFeatures: [
    'IC memo PDF export with a formatted evidence register',
...
const softwareRollups: BuyerPageData = {
  ...
  subheadline:
    'Rank add-ons across the full pipeline by strategic fit, evidence quality, AI risk, integration complexity and next action.',
  ...
  howHelps: [
    ...
    'Origination: rank targets against a buyer thesis.',
  ],
...
const corporateDevelopment: BuyerPageData = {
  ...
  subheadline:
    'Frontier OS assesses adjacency, build-vs-buy urgency, cross-sell potential, integration risk and AI capability gaps before NDA work begins.',
  ...
  howHelps: [
    ...
    'Integration risk flags covering product, customer and technology overlap.',
...
const searchFunds: BuyerPageData = {
  ...
  painPoints: [
    ...
    'Customer concentration can end a deal and is often discovered too late.',
    'Some software targets are too operationally complex for a first-time operator.',
  ],
  howHelps: [
    'Search fund fit score covering durability, simplicity and owner-transition readiness.',
...
const founders: BuyerPageData = {
  ...
  subheadline:
    'Frontier OS shows how buyers may assess your revenue quality, ARR bridge, customer concentration, AI claims, evidence gaps and IC readiness before a process begins.',
  badge: 'FOUNDERS',
  painPoints: [
  ...
  howHelps: [
    ...
    'Investor challenge map: questions a PE, strategic or search fund would ask.',
    'Evidence gap list: claims unverified by public sources.',
    'AI defensibility questions: how buyers will test your AI case.',
  ...
  lockedFeatures: [
    ...
    'Investor challenge simulator with questions by buyer type',
...
const vcGrowth: BuyerPageData = {
  ...
  subheadline:
    'Frontier OS screens software companies for revenue quality, AI defensibility, product risk and evidence gaps before the first partner meeting.',
  badge: 'VC / GROWTH',
  painPoints: [
    'AI claims are common. Most lack supporting evidence.',
  ...
  howHelps: [
    ...
    'AI moat evidence covering proprietary data, workflows, switching costs and network effects.',
    'Inference economics questions covering margin risk as AI usage scales.',
  ...
  lockedFeatures: [
    'Portfolio monitoring with scheduled holding reviews',
    'AI moat trajectory tracking over time',
